...
features:
  feature1: Designed to fit the Nikon D5.
...
included:
  item1: C1893 Water Housing with Front Shutter, Zoom Control and Electronic Cabling.
...
description: "This water housing for Nikon D5 is constructed from high-strength, extremely durable polyurethane. The controls are ergonomically designed and built using marine grade stainless steel, and tough composites. This water housing include a front shutter button and zoom control. The C1893 package includes the L-LP-65 port and features an interchangeable port system for the Nikon lens series, the LP Series Lens Port system."
---
...
The C1893 package includes the L-LP-65 port and features an interchangeable port system for the Nikon lens series. This water housing uses the LP Series Lens Port system.
